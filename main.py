...
async def check_ban_command(ctx):
    ...
    if not user_id.isdigit():
        message = {
            "en": f"{ctx.author.mention} ❌ **[DUTCH X COMMUNITY ] Invalid UID!**\n➡️ Please use: `!ID 123456789`",
            "fr": f"{ctx.author.mention} ❌ **[DUTCH X COMMUNITY ] UID invalide !**\n➡️ Veuillez fournir un UID valide sous la forme : `!ID 123456789`"
        }
    ...
    async with ctx.typing():
        ...
        if is_banned:
            ...
            embed.set_image(url="https://cdn.discordapp.com/attachments/1370600400432136303/1373946042768293980/f4c18e810d4f636220fb6d6f775acf48.png?ex=682c4277&is=682af0f7&hm=3bdd739e135de7fe19d1b664a6cfac9de4e6bc069b8e0d2ad29e8986a25f4ded&")
        else:
        ...
        embed.set_footer(text="📌  By DutchLove")
